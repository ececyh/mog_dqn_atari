...
def _cnn_to_dist_mlp(convs, hiddens, dueling, inpt, num_actions, nb_atoms, scope, reuse=False, layer_norm=False):
    with tf.variable_scope(scope, reuse=reuse):
        ...
        with tf.variable_scope("action_value"):
            ...
            action_scores = layers.fully_connected(action_out, num_outputs=num_actions * 3 * nb_atoms, activation_fn=None)
        ...
        if dueling:
            ...
            _out = tf.reshape(action_scores, shape=[-1, num_actions, 3*nb_atoms])
